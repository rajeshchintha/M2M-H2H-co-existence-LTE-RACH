...
double HttpRandomVariableBase :: GetValue()
{
return 0.0;
}
uint32_t HttpRandomVariableBase :: GetInteger()
{
return 0;
}
...
uint32_t fArimaImpl:: GetInteger()
{
return 0;
}
...
uint32_t HttpFileSizeRandomVariableImpl:: GetInteger()
{
return 0;
}
