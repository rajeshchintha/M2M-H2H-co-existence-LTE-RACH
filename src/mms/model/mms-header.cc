...
MmsTypeHeader::Serialize (Buffer::Iterator start) const
{
	...
	start.WriteHtonU32(m_MmsConfirmedRequestParam1);
...
MmsTypeHeader::Deserialize (Buffer::Iterator start)
{
	...
	m_MmsConfirmedRequestParam1 = i.ReadNtohU32();
...
MmsTypeHeader::SetType(int typeMms, int typeConfirmed, int m_nReq)
{
	...
	if (typeMms == CONFIRMED_REQUEST)
	{
		...
		{
			m_MmsConfirmedRequestParam1 = 0x82010702;  //0x4102 (old value)
	...
	if (typeMms == CONFIRMED_RESPONSE)
	{
		...
		if (typeConfirmed == READ)
		{
			m_MmsConfirmedRequestParam1 = 0x0d02;
			m_MmsConfirmedRequestParam2 = 0x01;
			m_invokeId = m_nReq;
			m_mmsConfirmedType = typeConfirmed + 0xa0;
		}
...
{
	 m_Length = 0x08;
	 m_mmsReadResponseParam = 0xa1068504;
...
MmsConfirmedReadResponseHeader::Serialize (Buffer::Iterator start) const
{
	...
	start.WriteHtonU32(m_mmsReadResponseParam);
...
MmsConfirmedReadResponseHeader::Deserialize (Buffer::Iterator start)
{
	Buffer::Iterator i = start;
	m_Length = i.ReadU8() ;
	m_mmsReadResponseParam = i.ReadNtohU32() ;
...
{
	m_mmsConfirmedTypeLength1 = 0x8201;
	m_mmsConfirmedTypeLength2 = 0x00a0;
	m_mmsConfirmedTypeParam1 = 0x8200;
	m_mmsConfirmedTypeParam2 = 0xfc;
	m_mmsConfirmedTypeParam2_2 = 0x302ca02a;
	m_mmsConfirmedTypeParam3 = 0xa128;

	m_MmsReportName1 = 0x1a0b;
	m_MmsReportName2 = 0x5056496E76657274;
	m_MmsReportName3 = 0x6572;
	m_MmsReportName4 = 0x31;

	m_MmsReportName5 = 0x1a19;
	m_MmsReportName6 = 0x59494E5631244F75;
	m_MmsReportName7 = 0x7457536574244F70;
	m_MmsReportName8 = 0x657224636C745661;
	m_MmsReportName9 = 0x6C;

	m_mmsReport1 = 0x302ca02a;
	m_mmsReport2 = 0xa128;

	m_MmsReport3 = 0x1a0b;
	m_MmsReport4 = 0x5056496E76657274;
	m_MmsReport5 = 0x6572;
	m_MmsReport6 = 0x31;

	m_MmsReportName10 = 0x1a19;
	m_MmsReportName11 = 0x59494E5631244F75;
	m_MmsReportName12 = 0x7457536574244F70;
	m_MmsReportName13 = 0x6572244F72696769;
	m_MmsReportName14 = 0x6E;

	m_mmsReport7 = 0x302ca02a;
	m_mmsReport8 = 0xa128;

	m_MmsReport9 = 0x1a0b;
	m_MmsReport10 = 0x5056496E76657274;
	m_MmsReport11 = 0x6572;
	m_MmsReport12 = 0x31;

	m_MmsReportName15 = 0x1a19;
	m_MmsReportName16 = 0x59494E5631244F75;
	m_MmsReportName17 = 0x7457536574244F70;
	m_MmsReportName18 = 0x657224636C744E75;
	m_MmsReportName19 = 0x6D;

	m_mmsReport13 = 0x302aa028;
	m_mmsReport14 = 0xa126;

	m_MmsReport15 = 0x1a0b;
	m_MmsReport16 = 0x5056496E76657274;
	m_MmsReport17 = 0x6572;
	m_MmsReport18 = 0x31;

	m_MmsReportName20 = 0x1a17;
	m_MmsReportName21 = 0x59494e5631244f75;
	m_MmsReportName22 = 0x7457536572244f70;
	m_MmsReportName23 = 0x65722454;
	m_MmsReportName24 = 0x6573;
	m_MmsReportName25 = 0x74;

	m_mmsReport19 = 0x3027a025;
	m_mmsReport20 = 0xa123;

	m_MmsReport21 = 0x1a0b;
	m_MmsReport22 = 0x5056496E76657274;
	m_MmsReport23 = 0x6572;
	m_MmsReport24 = 0x31;

	m_MmsReportName31 = 0x1a14;
	m_MmsReportName32 = 0x59494e5631244f75;
	m_MmsReportName33 = 0x7457536572244f70;
	m_MmsReportName34 = 0x65722454;


	m_MmsReportName26 = 0x301ba019;
	m_MmsReportName27 = 0x850203e88a0a4374;
	m_MmsReportName28 = 0x726c43656e746572;
	m_MmsReportName29 = 0x85013283;
	m_MmsReportName30 = 0x0100;
	m_MmsReportName35 = 0x8501;
	m_MmsReportName36 = 0x64;
...
//		start.WriteHtonU32(m_data);
	...
	start.WriteHtonU16(m_mmsConfirmedTypeLength1);
	start.WriteHtonU16(m_mmsConfirmedTypeLength2);

	start.WriteHtonU16(m_mmsConfirmedTypeParam1);
	start.WriteU8(m_mmsConfirmedTypeParam2);
	start.WriteHtonU32(m_mmsConfirmedTypeParam2_2);
	start.WriteHtonU16(m_mmsConfirmedTypeParam3);

	start.WriteHtonU16(m_MmsReportName1);
	start.WriteHtonU64(m_MmsReportName2);
	start.WriteHtonU16(m_MmsReportName3);
	start.WriteU8(m_MmsReportName4);

	start.WriteHtonU16(m_MmsReportName5);
	start.WriteHtonU64(m_MmsReportName6);
	start.WriteHtonU64(m_MmsReportName7);
	start.WriteHtonU64(m_MmsReportName8);
	start.WriteU8(m_MmsReportName9);

	start.WriteHtonU32(m_mmsReport1);
	start.WriteHtonU16(m_mmsReport2);

	start.WriteHtonU16(m_MmsReport3);
	start.WriteHtonU64(m_MmsReport4);
	start.WriteHtonU16(m_MmsReport5);
	start.WriteU8(m_MmsReport6);

	start.WriteHtonU16(m_MmsReportName10);
	start.WriteHtonU64(m_MmsReportName11);
	start.WriteHtonU64(m_MmsReportName12);
	start.WriteHtonU64(m_MmsReportName13);
	start.WriteU8(m_MmsReportName14);

	start.WriteHtonU32(m_mmsReport7);
	start.WriteHtonU16(m_mmsReport8);

	start.WriteHtonU16(m_MmsReport9);
	start.WriteHtonU64(m_MmsReport10);
	start.WriteHtonU16(m_MmsReport11);
	start.WriteU8(m_MmsReport12);

	start.WriteHtonU16(m_MmsReportName15);
	start.WriteHtonU64(m_MmsReportName16);
	start.WriteHtonU64(m_MmsReportName17);
	start.WriteHtonU64(m_MmsReportName18);
	start.WriteU8(m_MmsReportName19);

	start.WriteHtonU32(m_mmsReport13);
	start.WriteHtonU16(m_mmsReport14);

	start.WriteHtonU16(m_MmsReport15);
	start.WriteHtonU64(m_MmsReport16);
	start.WriteHtonU16(m_MmsReport17);
	start.WriteU8(m_MmsReport18);

	start.WriteHtonU16(m_MmsReportName20);
	start.WriteHtonU64(m_MmsReportName21);
	start.WriteHtonU64(m_MmsReportName22);
	start.WriteHtonU32(m_MmsReportName23);
	start.WriteHtonU16(m_MmsReportName24);
	start.WriteU8(m_MmsReportName25);

	start.WriteHtonU32(m_mmsReport19);
	start.WriteHtonU16(m_mmsReport20);

	start.WriteHtonU16(m_MmsReport21);
	start.WriteHtonU64(m_MmsReport22);
	start.WriteHtonU16(m_MmsReport23);
	start.WriteU8(m_MmsReport24);

	start.WriteHtonU16(m_MmsReportName31);
	start.WriteHtonU64(m_MmsReportName32);
	start.WriteHtonU64(m_MmsReportName33);
	start.WriteHtonU32(m_MmsReportName34);

	start.WriteHtonU32(m_MmsReportName26);
	start.WriteHtonU64(m_MmsReportName27);
	start.WriteHtonU64(m_MmsReportName28);
	start.WriteHtonU32(m_MmsReportName29);
	start.WriteHtonU16(m_MmsReportName30);
	start.WriteHtonU16(m_MmsReportName35);
	start.WriteU8(m_MmsReportName36);
...
//		m_data = i.ReadNtohU32() ;
	    ...
	    Buffer::Iterator i = start;
		m_mmsConfirmedTypeLength1 = i.ReadNtohU16();
		m_mmsConfirmedTypeLength2 = i.ReadNtohU16();

		m_mmsConfirmedTypeParam1 = i.ReadNtohU16();
		m_mmsConfirmedTypeParam2 = i.ReadU8();
		m_mmsConfirmedTypeParam2_2 = i.ReadNtohU32();
		m_mmsConfirmedTypeParam3 = i.ReadNtohU16();

		m_MmsReportName1 = i.ReadNtohU16() ;
		m_MmsReportName2 = i.ReadNtohU64() ;
		m_MmsReportName3 = i.ReadNtohU16() ;
		m_MmsReportName4 = i.ReadU8() ;

		m_MmsReportName5 = i.ReadNtohU16() ;
		m_MmsReportName6 = i.ReadNtohU64() ;
		m_MmsReportName7 = i.ReadNtohU64() ;
		m_MmsReportName8 = i.ReadNtohU64() ;
		m_MmsReportName9 = i.ReadU8() ;

		m_mmsReport1 = i.ReadNtohU32() ;
		m_mmsReport2 = i.ReadNtohU16() ;
		m_MmsReport3 = i.ReadNtohU16() ;
		m_MmsReport4 = i.ReadNtohU64() ;

		m_MmsReport5 = i.ReadNtohU16() ;
		m_MmsReport6 = i.ReadU8() ;

		m_MmsReportName10 = i.ReadNtohU16() ;
		m_MmsReportName11 = i.ReadNtohU64() ;
		m_MmsReportName12 = i.ReadNtohU64() ;
		m_MmsReportName13 = i.ReadNtohU64() ;
		m_MmsReportName14 = i.ReadU8() ;

		m_mmsReport7 = i.ReadNtohU32() ;
		m_mmsReport8 = i.ReadNtohU16() ;
		m_MmsReport9 = i.ReadNtohU16() ;
		m_MmsReport10 = i.ReadNtohU64() ;

		m_MmsReport11 = i.ReadNtohU16() ;
		m_MmsReport12 = i.ReadU8() ;

		m_MmsReportName15 = i.ReadNtohU16() ;
		m_MmsReportName16 = i.ReadNtohU64() ;
		m_MmsReportName17 = i.ReadNtohU64() ;
		m_MmsReportName18 = i.ReadNtohU64() ;
		m_MmsReportName19 = i.ReadU8() ;

		m_mmsReport13 = i.ReadNtohU32() ;
		m_mmsReport14 = i.ReadNtohU16() ;
		m_MmsReport15 = i.ReadNtohU16() ;
		m_MmsReport16 = i.ReadNtohU64() ;

		m_MmsReport17 = i.ReadNtohU16() ;
		m_MmsReport18 = i.ReadU8() ;

		m_MmsReportName20 = i.ReadNtohU16() ;
		m_MmsReportName21 = i.ReadNtohU64() ;
		m_MmsReportName22 = i.ReadNtohU64() ;
		m_MmsReportName23 = i.ReadNtohU32() ;
		m_MmsReportName24 = i.ReadNtohU16() ;
		m_MmsReportName25 = i.ReadU8() ;

		m_mmsReport19 = i.ReadNtohU32() ;
		m_mmsReport20 = i.ReadNtohU16() ;
		m_MmsReport21 = i.ReadNtohU16() ;
		m_MmsReport22 = i.ReadNtohU64() ;

		m_MmsReport23 = i.ReadNtohU16() ;
		m_MmsReport24 = i.ReadU8() ;

		m_MmsReportName31 = i.ReadNtohU16() ;
		m_MmsReportName32 = i.ReadNtohU64() ;
		m_MmsReportName33 = i.ReadNtohU64() ;
		m_MmsReportName34 = i.ReadNtohU32() ;

		m_MmsReportName26 = i.ReadNtohU32() ;
		m_MmsReportName27 = i.ReadNtohU64() ;
		m_MmsReportName28 = i.ReadNtohU64() ;
		m_MmsReportName29 = i.ReadNtohU32() ;
		m_MmsReportName30 = i.ReadNtohU16() ;
		m_MmsReportName35 = i.ReadNtohU16() ;
		m_MmsReportName36 = i.ReadU8() ;
...
{
	m_idPpdu1 = 0x61;  // PPDU identifier (2B) = 0x3181
	m_idPpdu2 = 0x8201;  // SPDU Length (1B) = 0x88
	m_length1 = 0;
	m_param1 = 0x30;
	m_param2 = 0x8201;
	m_length2 = 0;
...
{
	start.WriteU8(m_idPpdu1);  // PPDU identifier (2B) = 0x3181
	start.WriteHtonU16(m_idPpdu2);
	start.WriteU8(m_length1);
	start.WriteU8(m_param1);
	start.WriteHtonU16(m_param2);  // SPDU Length (1B) = 0x88
	start.WriteU8(m_length2);
	start.WriteHtonU32(m_param3);
	start.WriteHtonU16(m_param4);
	start.WriteU8(m_length3);
}
...
{
	Buffer::Iterator i = start;
	m_idPpdu1 = i.ReadU8();  // PPDU identifier (2B) = 0x3181
	m_idPpdu2 = i.ReadNtohU16();
	m_length1 = i.ReadU8();  // SPDU Length (1B) = 0x88
	m_param1 = i.ReadU8();
	m_param2 = i.ReadNtohU16();
	m_length2 = i.ReadU8();
	m_param3 = i.ReadNtohU32();
	m_param4 = i.ReadNtohU16();
	m_length3 = i.ReadU8();
	return GetSerializedSize ();
}
...
void MmsPresentationHeader::SetLength(uint8_t length)
{
	m_length3 = length;
	m_length2 = length + 7;
	m_length1 = length + 11;
