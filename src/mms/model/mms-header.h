...
private:
	...
	uint32_t m_MmsConfirmedRequestParam1;
...
private:
	uint8_t m_Length;
	uint32_t m_mmsReadResponseParam;
...
private:
	...
	uint16_t m_mmsConfirmedTypeLength1;
	uint16_t m_mmsConfirmedTypeLength2;
	uint16_t m_mmsConfirmedTypeParam1;
	uint8_t m_mmsConfirmedTypeParam2;
	uint32_t m_mmsConfirmedTypeParam2_2;
	uint16_t m_mmsConfirmedTypeParam3;

	uint16_t m_MmsReportName1;
	uint64_t m_MmsReportName2;
	uint16_t m_MmsReportName3;
	uint8_t m_MmsReportName4;

	uint16_t m_MmsReportName5;
    uint64_t m_MmsReportName6;
    uint64_t m_MmsReportName7;
    uint64_t m_MmsReportName8;
	uint8_t m_MmsReportName9;

	uint32_t m_mmsReport1;
	uint16_t m_mmsReport2;

	uint16_t m_MmsReport3;
	uint64_t m_MmsReport4;
	uint16_t m_MmsReport5;
	uint8_t  m_MmsReport6;

	uint16_t m_MmsReportName10;
	uint64_t m_MmsReportName11;
	uint64_t m_MmsReportName12;
	uint64_t m_MmsReportName13;
	uint8_t m_MmsReportName14;

	uint32_t m_mmsReport7;
	uint16_t m_mmsReport8;

	uint16_t m_MmsReport9;
	uint64_t m_MmsReport10;
	uint16_t m_MmsReport11;
	uint8_t  m_MmsReport12;

	uint16_t m_MmsReportName15;
	uint64_t m_MmsReportName16;
	uint64_t m_MmsReportName17;
	uint64_t m_MmsReportName18;
	uint8_t m_MmsReportName19;

	uint32_t m_mmsReport13;
	uint16_t m_mmsReport14;

	uint16_t m_MmsReport15;
	uint64_t m_MmsReport16;
	uint16_t m_MmsReport17;
	uint8_t  m_MmsReport18;

	uint16_t m_MmsReportName20;
	uint64_t m_MmsReportName21;
	uint64_t m_MmsReportName22;
	uint32_t m_MmsReportName23;
	uint16_t m_MmsReportName24;
	uint8_t m_MmsReportName25;

	uint32_t m_MmsReportName26;
	uint64_t m_MmsReportName27;
	uint64_t m_MmsReportName28;
	uint32_t m_MmsReportName29;
	uint16_t m_MmsReportName30;

	uint32_t m_mmsReport19;
	uint16_t m_mmsReport20;

	uint16_t m_MmsReport21;
	uint64_t m_MmsReport22;
	uint16_t m_MmsReport23;
	uint8_t  m_MmsReport24;

	uint16_t m_MmsReportName31;
	uint64_t m_MmsReportName32;
	uint64_t m_MmsReportName33;
	uint32_t m_MmsReportName34;
	uint16_t m_MmsReportName35;
	uint8_t m_MmsReportName36;
...
private:
	...
	uint8_t m_idPpdu1;  // PPDU identifier (2B) = 0x3181
	uint16_t m_idPpdu2;
	uint8_t m_length1;  // SPDU Length (1B) = 0x88
	uint8_t m_param1;
	uint16_t m_param2;
	uint8_t m_length2;
	uint32_t m_param3;
