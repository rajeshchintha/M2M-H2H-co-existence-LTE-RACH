...
//==========================================  Copied from https://github.com/signetlabdei/lena-plus =======================================
	lteHelper->SetSchedulerType("ns3::PfFfMacScheduler");// refer DungNGuyen pg:11		
...
//	}
	...
	GeneralUdpServerHelper lteGamingRemoteServer (lteGamingRemotePort, 1);
